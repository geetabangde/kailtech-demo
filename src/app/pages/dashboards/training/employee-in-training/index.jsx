...
import { PrepareTrainingPlannerModal } from "../employee-pending-for-training/PrepareTrainingPlannerModal";
import { ApproveTrainingPlannerModal } from "../employee-pending-for-training/ApproveTrainingPlannerModal";

const isSafari = getUserAgentBrowser() === "Safari";

export default function EmployeeInTrainingDatatable() {
  ...
  const fetchEmployees = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`/training/employees-in-training-list`);
      ...
      console.error("Error fetching employees in training:", err);
      // Mock data for UI testing if API is missing
      setEmployees([
        { id: 1, firstname: "Alice", lastname: "Smith", empid: "EMP1003", mobile: "9876543212", email: "alice@example.com", dname: "Training", status: 14, status_text: "In training", joiningdate: "2024-03-10" }
      ]);
    } finally {
      setLoading(false);
    }
  ...
  const [columnVisibility, setColumnVisibility] = useLocalStorage(
    "column-visibility-employee-in-training",
    {},
  );
  const [columnPinning, setColumnPinning] = useLocalStorage(
    "column-pinning-employee-in-training",
    {},
  );
  ...
  return (
    <Page title="Employee In Training">
