        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm mb-4">
          ...
          <form onSubmit={handleSubmit} className="p-6">
            ...
            <div className="mb-6">
              ...
              {selectedTableData && (tableStructure || selectedTableData.id === 'observationdw' || selectedTableData.id === 'observationwb' || selectedTableData.id === 'observationbiomedical' || selectedTableData.id === 'observationvc' || selectedTableData.id === 'observationapg' || selectedTableData.id === 'observationutm' || selectedTableData.id === 'observationcustom' || selectedTableData.id === 'observationexm' || selectedTableData.id === 'observationgtm') && (<div className="space-y-6">
